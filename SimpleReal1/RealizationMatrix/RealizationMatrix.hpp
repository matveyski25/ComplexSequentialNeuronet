...
//#define template<typename T, typename Enable = std::enable_if_t<std::is_arithmetic_v<T>>> template<typename T, typename Enable = std::enable_if_t<std::is_arithmetic_v<T>>>
